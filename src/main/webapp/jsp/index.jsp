...
<head>
    ...
    <title>BLOG  | Squirrel Chen </title>
        ...
        <div class="am-collapse am-topbar-collapse" id="blog-collapse">
            ...
            <form class="am-topbar-form am-topbar-right am-form-inline" role="search">
                <div class="am-form-group">
                    <input type="text" class="am-form-field am-input-sm" placeholder="搜索"><span>      </span><button class="am-btn am-btn-primary am-round">搜索一下<i class="am-icon-search"> </i></button>
                </div>
            </form>
        </div>
    </nav>
...
<div class="am-g am-g-fixed blog-fixed">
    ...
    <div class="am-u-md-4 am-u-sm-12 blog-sidebar">
        <div class="blog-sidebar-widget blog-bor" id="myinfo">
        ...
        <div class="blog-clear-margin blog-sidebar-widget blog-bor am-g " >
            <h2 class="blog-title"><span>My Tags</span></h2>
            <div class="am-u-sm-12 blog-clear-padding"id="mytags">
...
<footer class="blog-footer">
    <div class="am-g am-g-fixed blog-fixed am-u-sm-centered blog-footer-padding">
        ...
        <div class="am-u-sm-12 am-u-md-4- am-u-lg-4">
            ...
            <h3>Introduction Card</h3>
            <p>本博客前端基于Amaze UI的二次开发，然个人时间、经验、技术均有所限制，必有很多不足之处。若有意见或建议，望Email与我，感谢不尽!!!</p>
        </div>
        <div class="am-u-sm-12 am-u-md-4- am-u-lg-4">
            <h1>我们之所以能站的高，看的远，那是因为我们站在巨人的肩膀上</h1>
        </div>
    </div>
